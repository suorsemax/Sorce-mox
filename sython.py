...
async def _(event):
        ...
        await sython.send_message('@EEObot', 'جاري التجميع بواسطة | Turbo MAX')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة | Turbo MAX')
        channel_entity = await sython.get_entity(bot_usernamee)
